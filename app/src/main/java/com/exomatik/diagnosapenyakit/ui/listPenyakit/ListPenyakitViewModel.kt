...
import com.exomatik.diagnosapenyakit.ui.editPenyakit.EditPenyakitFragment
...
class ListPenyakitViewModel(private val rcPenyakit: RecyclerView,
    ...
    private fun onClickItem(dataPenyakit: ModelPenyakit){
        val bundle = Bundle()
        val frag = EditPenyakitFragment()
        bundle.putParcelable(Constant.dataPenyakit, dataPenyakit)
        frag.arguments = bundle
        navController.navigate(R.id.editPenyakitFragment, bundle)
    }
